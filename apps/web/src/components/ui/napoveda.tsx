...
const HELP: Record<string, HelpEntry> = {
  ...
  "/dashboard/fans": {
    ...
    sections: [
      ...
      { heading: "Jak zvednout reputaci trenera", text: "Vyhra +1 (o tri a vic golu +2), prohra −1 (debakl −2) — projevi se asi v tretine zapasu. Konec sezony: prvni misto ve 14 tymech +11, posledni −11. Pohar: ctvrtfinale +3, semifinale +5, vyhra ve finale +8. Rozsah 15–75." },
