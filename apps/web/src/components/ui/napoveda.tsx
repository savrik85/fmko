...
const HELP: Record<string, HelpEntry> = {
  "/prehled": {
    ...
    sections: [
      ...
      { heading: "Trenér", text: "Koučink násobí šanci na zlepšení hráčů při tréninku. Motivace před zápasem zvedne morálku celému kádru (při 60 o tři body), taktika přidá nebo ubere přihrávky a obranu (při 60 +1, pod 33 do minusu). Disciplína ubírá fauly a karty. Co přesně dělá každá vlastnost, ukazuje profil trenéra. Vlastnosti se vyvíjejí obousměrně: koučink a taktika rostou častěji po výhře, prohra občas srazí motivaci. Reputace roste za výhry a klesá za prohry." },
  ...
  "/fanousci": {
    ...
    sections: [
      ...
      { heading: "Vliv trenéra", text: "Vliv = 0,4 × reputace + 0,25 × motivace + 0,35 × forma týmu, neutrál je 44. Pásma po pěti bodech: 47–51 dává +1, 52–56 dává +2, 57 a víc +3. Pásmo 42–46 je nula. Níže se jde do minusu: 37–41 je −1, 32–36 je −2, 31 a míň −3." },
  ...
  const stepHelp: Record<string, HelpEntry> = {
    ...
    manager: {
      ...
      sections: [
        ...
        { heading: "Motivace", text: "Před zápasem zvedne morálku sestavy (při 60 o tři body). Hráči, kteří nejedou na zápas, to u motivátora nesou líp." },
        { heading: "Taktika", text: "Přidá nebo ubere celé sestavě přihrávky a obranu (při 10 −2, při 60 +1, při 99 +4) a zrychlí sehrávání formace." },
        { heading: "Disciplína", text: "Hýbe docházkou na trénink, ubírá fauly a žluté karty a krotí průšvihy v hospodě." },
        { heading: "Práce s mládeží", text: "Zrychlí trénink i růst z odehraných minut u hráčů do 22 let." },
        { text: "Vlastnosti trenéra se mění po zápasech a na konci sezóny. Co přesně která dělá, ukazuje profil trenéra.", tip: true },
      ],
    },
    club: {
      title: "Název klubu",
