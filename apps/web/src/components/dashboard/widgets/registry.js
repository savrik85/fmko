...
import { StandingsWidget, SeasonRecordWidget, TopScorersWidget, TopAssistsWidget, TopRatedWidget, ResultsDonutWidget, PointsProgressionWidget, GoalsPerRoundWidget, HomeAwaySplitWidget, LeagueScorersWidget, LeagueCardsWidget, CupProgressWidget, SeasonHistoryWidget, } from "./items/league-widgets";
import { SquadStatusWidget, SquadPositionsWidget, SquadAgeWidget, SquadSkillsWidget, ConditionRankingWidget, MoraleRankingWidget, SquadValueWidget, WageStructureWidget, InjuriesWidget, BestPlayersWidget, YoungTalentsSeniorWidget, YoungTalentsU21Widget, } from "./items/squad-widgets";
import { BudgetSummaryWidget, BudgetForecastWidget, BudgetHistoryWidget, IncomeBreakdownWidget, ExpenseBreakdownWidget, SponsorsWidget, ConcessionRevenueWidget, } from "./items/finance-widgets";
import { FanSatisfactionWidget, FanSatisfactionHistoryWidget, FanbaseHistoryWidget, AttendanceHistoryWidget, StadiumRadarWidget, } from "./items/fans-widgets";
import { ManagerCardWidget, ManagerRadarWidget, ManagerHistoryWidget, ReputationWidget, TrainingBreakdownWidget, TopImproversWidget, TrainingAttendanceWidget, BestAttendanceWidget, MostAbsentWidget, EquipmentWidget, StaffWidget, U21Widget, TrophiesWidget, TransferOffersWidget, WatchlistWidget, } from "./items/club-widgets";
...
import { SquadScatterWidget, SeasonHeatmapWidget, BudgetWaterfallWidget, PositionProgressionWidget, SeasonNumbersWidget, PlayingTimeWidget, ManOfMatchWidget, CleanSheetsWidget, DisciplineWidget, } from "./items/analysis-widgets";
import { RivalsWidget, SquadChemistryWidget, FanVillagesWidget, SeasonProgressWidget, } from "./items/social-widgets";
