...
export default function OfferDetailPage() {
  ...
  if (error || !data) {
    return (
      <div className="max-w-3xl mx-auto p-6">
        <Link href="/prestupy" className="inline-flex items-center gap-1 text-sm font-heading font-bold text-muted hover:text-pitch-500 transition-colors mb-4">
          ← Zpět na přestupy
        </Link>
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-4">
      <Link href="/prestupy" className="inline-flex items-center gap-1 text-sm font-heading font-bold text-muted hover:text-pitch-500 transition-colors">
        ← Zpět na přestupy
      </Link>
