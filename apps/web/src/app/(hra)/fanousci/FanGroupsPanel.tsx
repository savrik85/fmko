  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0 flex-1">
        <Link href={`/fanousci/vudce/${leader.id}`} className="text-base font-semibold hover:underline">
          {leader.name}
        </Link>
    ...
    <div className="space-y-5">
      ...
      <div className="card p-4 sm:p-5">
        ...
        <p className="mt-2 text-sm text-muted">
          ...
          <Link href="/stadion" className="underline font-medium">stránce stadionu</Link>.
        </p>
      </div>
