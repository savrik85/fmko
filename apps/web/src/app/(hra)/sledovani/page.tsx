              ...
              return (
                <div key={p.id} className="card overflow-hidden">
                  ...
                  <div className="flex items-start gap-3 p-3 sm:p-4">
                    {/* Avatar */}
                    <Link href={`/hrac/${p.id}`} className="shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <Link href={`/hrac/${p.id}`} className="font-heading font-bold text-base sm:text-lg hover:text-pitch-500 transition-colors truncate">
                      ...
                      <div className="flex items-center gap-2 mt-1 text-xs text-muted flex-wrap">
                        ...
                        {p.teamId && p.teamName && (
                          <>
                            ...
                            <Link href={`/tym/${p.teamId}`} className="flex items-center gap-1 hover:text-pitch-500 transition-colors min-w-0">
                              <BadgePreview
                                primary={teamColor}
