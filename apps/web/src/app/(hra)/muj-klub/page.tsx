      ...
      <div className="page-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <SectionCard title="Identita" icon={"\u{1F3F7}️"} hint="Motto, přezdívka, založení, příběh">
            ...
            <EmptyState action={club.identity.nickname || club.identity.motto ? "Upravit identitu" : "Vyplnit identitu"} href="/muj-klub/identita">
          ...
          <SectionCard title="Stadion" icon={"\u{1F3DF}️"} hint="Kapacita, přezdívka, tribuny">
            ...
            <EmptyState action={club.stadium.name ? "Upravit stadion" : "Doplnit stadion"} href="/muj-klub/stadion">
          ...
          <SectionCard title="Dres a znak" icon={"\u{1F455}"} hint="Domácí, hostující, vzor a barvy">
            ...
            <EmptyState action="Upravit dres" href="/muj-klub/dres">
