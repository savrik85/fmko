            ...
            <a href={`/dashboard/manager/${teamId}`} className="block group">
              <div className="flex items-center gap-3">
                {manager.avatar && Object.keys(manager.avatar).length > 2 ? (
                  ...
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center font-heading font-bold text-lg shrink-0 ${bestTextOn(color) === "light" ? "text-white border border-transparent" : "text-gray-900 border border-gray-300"}`} style={{ backgroundColor: color }}>
                    {manager.name[0]}
                  </div>
                )}
