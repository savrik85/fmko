...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    items: [
      ...
      "Spravit se to dá na Stadionu v Údržbě trávníku. Základní údržba (posečení a zarovnání) přidá deset procent za 1 600 Kč, důkladná (přesetí holých míst a hnojení) dvacet pět procent za 3 000 Kč a renovace povrchu padesát procent za 5 000 Kč. Čím větší zásah, tím levnější na procento, takže se vyplatí nechat to dojít a spravit najednou. Kdo má v šatně sekačku s traktůrkem, tomu trávník část dní nechátrá vůbec, u nejvyšší úrovně v dobrém stavu skoro pořád. Kdo chce mít pokoj, může přejít na hybridní povrch za 85 000 Kč, ten toho snese víc než přírodní tráva.",
