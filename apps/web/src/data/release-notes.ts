...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    items: [
      ...
      "Ve větru se centry rozhodí dřív, než doletí. V dešti a sněhu je naopak těžký míč pro gólmany noční můra a hlavičkářům nahrává.",
      "Gólů celkem padá stejně jako dřív, jen se jinak rozdělily. Tabulky se tím nerozhodí.",
      "Na stránce Sestava je nová karta Role v týmu. Vybereš v ní kapitána, exekutora penalt a exekutora přímých kopů a rohů. U každé role je napsané, co o ní rozhoduje, a hráči jsou seřazení podle svých čísel — hned vidíš, proč je jeden nad druhým.",
