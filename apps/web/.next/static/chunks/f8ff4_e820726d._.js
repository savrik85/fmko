...
"[project]/Projects/fmko/node_modules/facesjs/build/override.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Projects/fmko/node_modules/facesjs/build/svgs.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Projects/fmko/node_modules/facesjs/build/display.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$override$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/facesjs/build/override.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$svgs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/facesjs/build/svgs.js [app-client] (ecmascript)");
;
;
const addWrapper = (svgString)=>"<g>".concat(svgString, "</g>");
const addTransform = (element, newTransform)=>{
    const oldTransform = element.getAttribute("transform");
    element.setAttribute("transform", "".concat(oldTransform ? "".concat(oldTransform, " ") : "").concat(newTransform));
};
const rotateCentered = (element, angle)=>{
    const bbox = element.getBBox();
    const cx = bbox.x + bbox.width / 2;
    const cy = bbox.y + bbox.height / 2;
    addTransform(element, "rotate(".concat(angle, " ").concat(cx, " ").concat(cy, ")"));
};
...
const scaleCentered = (element, x, y)=>{
    ...
    const tx = cx * (1 - x) / x;
    const ty = cy * (1 - y) / y;
    addTransform(element, "scale(".concat(x, " ").concat(y, ") translate(").concat(tx, " ").concat(ty, ")"));
...
const translate = function(element, x, y) {
    let xAlign = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "center", yAlign = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : "center";
    const bbox = element.getBBox();
    let cx;
    let cy;
    if (xAlign === "left") {
    ...
    addTransform(element, "translate(".concat(x - cx, " ").concat(y - cy, ")"));
};
// Defines the range of fat/skinny, relative to the original width of the default head.
const fatScale = (fatness)=>0.8 + 0.2 * fatness;
const drawFeature = (svg, face, info)=>{
    const feature = face[info.name];
    if (!feature || !__TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$svgs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"][info.name]) {
        return;
    }
    if ([
        "hat",
    ...
    // @ts-expect-error
    let featureSVGString = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$svgs$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"][info.name][feature.id];
    if (!featureSVGString) {
        return;
    }
    // @ts-expect-error
...
const display = (container, face, overrides)=>{
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$override$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(face, overrides);
...
"[project]/Projects/fmko/node_modules/facesjs/build/svgs-index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Projects/fmko/node_modules/facesjs/build/common.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Projects/fmko/node_modules/facesjs/build/utils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Projects/fmko/node_modules/dlv/dist/dlv.umd.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/Projects/fmko/node_modules/dset/dist/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Projects/fmko/node_modules/facesjs/build/generateRelative.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$dlv$2f$dist$2f$dlv$2e$umd$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/dlv/dist/dlv.umd.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$dset$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/dset/dist/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$generate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/facesjs/build/generate.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$common$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/facesjs/build/common.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/facesjs/build/utils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$svgs$2d$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/facesjs/build/svgs-index.js [app-client] (ecmascript)");
;
;
;
;
...
const imputeRace = (face)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$common$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["races"].find((race)=>__TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$generate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["colors"][race].skin.includes(face.body.color));
};
const generateRelative = (param)=>{
    let { gender, race: inputRace, relative } = param;
    const face = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepCopy"])(relative);
    const race = inputRace !== null && inputRace !== void 0 ? inputRace : imputeRace(face);
    const randomFace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$generate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generate"])(undefined, {
        gender,
        race
    });
    ...
    for (const key of __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$common$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["features"]){
        const svgIndex = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$svgs$2d$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["svgsIndex"][key].findIndex((id)=>id === face[key].id);
        const svgGender = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$svgs$2d$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["svgsGenders"][key][svgIndex];
    ...
    for (const [path, ranges] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$generate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["numberRanges"])){
        const current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$dlv$2f$dist$2f$dlv$2e$umd$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(face, path);
        const range = ranges[gender];
        if (current < range[0] || current > range[1]) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$dset$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dset"])(face, path, (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$dlv$2f$dist$2f$dlv$2e$umd$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(randomFace, path));
        }
    }
    return face;
};
}),
"[project]/Projects/fmko/node_modules/facesjs/build/generate.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$common$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/facesjs/build/common.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/facesjs/build/utils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$generateRelative$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Projects/fmko/node_modules/facesjs/build/generateRelative.js [app-client] (ecmascript)");
;
;
;
;
...
const getID = (type, gender)=>{
    const validIDs = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$svgs$2d$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["svgsIndex"][type].filter((_id, index)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$svgs$2d$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["svgsGenders"][type][index] === "both" || __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$svgs$2d$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["svgsGenders"][type][index] === gender;
    });
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randChoice"])(validIDs);
};
const colors = {
    white: {
        skin: [
...
const getRandInt = (key, gender)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randInt"])(numberRanges[key][gender][0], numberRanges[key][gender][1]);
};
const getRandUniform = (key, gender)=>{
    return roundTwoDecimals((0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randUniform"])(numberRanges[key][gender][0], numberRanges[key][gender][1]));
};
const generate = (overrides, options)=>{
    var _options_gender;
    const gender = (_options_gender = options === null || options === void 0 ? void 0 : options.gender) !== null && _options_gender !== void 0 ? _options_gender : "male";
    let face;
    if (options === null || options === void 0 ? void 0 : options.relative) {
        face = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$generateRelative$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateRelative"])({
            gender,
            race: options.race,
        ...
        var _options_race;
        const race = (_options_race = options === null || options === void 0 ? void 0 : options.race) !== null && _options_race !== void 0 ? _options_race : (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randChoice"])(__TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$common$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["races"]);
        const palette = colors[race];
        const skinColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randChoice"])(palette.skin);
        const hairColor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$facesjs$2f$build$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["randChoice"])(palette.hair);
        face = {
            ...
            head: {
                ...
                shave: "rgba(0,0,0,".concat(gender === "male" && Math.random() < 0.25 ? getRandUniform("head.shave", gender) : 0, ")")
            },
            eyeLine: {
...
//# sourceMappingURL=f8ff4_e820726d._.js.map