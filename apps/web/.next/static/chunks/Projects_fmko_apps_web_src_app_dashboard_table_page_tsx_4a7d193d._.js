...
"[project]/Projects/fmko/apps/web/src/app/dashboard/table/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TablePage() {
    ...
    const [leagueName, setLeagueName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [standings, setStandings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TablePage.useEffect": ()=>{
            if (!teamId) return;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$apps$2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/api/teams/".concat(teamId, "/standings")).then({
                "TablePage.useEffect": (data)=>{
                    setLeagueName(data.leagueName);
                    setStandings(data.standings);
                    setLoading(false);
                }
            }["TablePage.useEffect"]).catch({
                "TablePage.useEffect": ()=>setLoading(false)
            }["TablePage.useEffect"]);
        }
    }["TablePage.useEffect"], [
        teamId
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: standings.length > 0 ? "".concat(standings[0].played, " odehraných kol") : "Zatím žádné zápasy"
            }, void 0, false, {
                fileName: "[project]/Projects/fmko/apps/web/src/app/dashboard/table/page.tsx",
                lineNumber: 45,
                columnNumber: 7
            }, this),
            standings.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    standings.map((row)=>{
                        var _row_form;
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "grid grid-cols-[2rem_1fr_2rem_2rem_2rem_2rem_3rem_2.5rem_4rem] gap-1 px-3 py-2.5 border-b border-gray-50 items-center text-xs ".concat(row.isPlayer ? "bg-pitch-500/5 font-bold" : "hover:bg-gray-50"),
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "text-center font-heading font-bold text-sm ".concat(row.pos <= 2 ? "text-pitch-500" : row.pos >= standings.length ? "text-card-red" : "text-muted"),
                                    children: row.pos
                                }, void 0, false, {
                                    fileName: "[project]/Projects/fmko/apps/web/src/app/dashboard/table/page.tsx",
                                    lineNumber: 71,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "truncate ".concat(row.isPlayer ? "text-pitch-600" : ""),
                                    children: row.team
                                }, void 0, false, {
                                    fileName: "[project]/Projects/fmko/apps/web/src/app/dashboard/table/page.tsx",
                                    lineNumber: 72,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: ((_row_form = row.form) !== null && _row_form !== void 0 ? _row_form : []).slice(0, 5).map((f, i)=>{
                                        var _FORM_COLORS_f;
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$fmko$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "w-3.5 h-3.5 rounded-full ".concat((_FORM_COLORS_f = FORM_COLORS[f]) !== null && _FORM_COLORS_f !== void 0 ? _FORM_COLORS_f : "bg-gray-300", " flex items-center justify-center text-white text-[8px] font-bold"),
                                            children: f
                                        }, i, false, {
                                            fileName: "[project]/Projects/fmko/apps/web/src/app/dashboard/table/page.tsx",
                                            lineNumber: 81,
...
_s(TablePage, "w7UEdBEamiAiqkjWvLfFYcFOns0=", false, function() {
    return [
...
//# sourceMappingURL=Projects_fmko_apps_web_src_app_dashboard_table_page_tsx_4a7d193d._.js.map