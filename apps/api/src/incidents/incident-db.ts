...
export interface IncidentRadek {
  ...
  /** Hráč, který čin donesl trenérovi (hospoda, spec 9a). Prázdné = donesl to hospodský. */
...
export const SLOUPCE_INCIDENTU = [
  ...
  "culprit_type", "culprit_player_id", "culprit_revealed", "reporter_player_id", "subject_player_id", "ends_on", "loss", "accusations", "accused",
