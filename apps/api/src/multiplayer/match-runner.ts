...
export async function runScheduledMatches(
    ...
    for (const match of matches.results) {
        ...
        try {
            ...
            // Včetně lavičky: střídající hráč dřív vztahy neměl vůbec, protože se subs
            // odřízli (splice) dřív, než se vztahy přiřazovaly. Engine si stejně při
            // každém použití ověří, že je protějšek na hřišti.
            {
